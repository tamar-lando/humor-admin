    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-50 to-indigo-100">
      <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-sm text-center">
        ...
        <form action={signIn}>
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 hover:border-slate-300 hover:shadow-md text-slate-700 font-medium py-3 px-4 rounded-xl transition-all duration-150 cursor-pointer"
          >
