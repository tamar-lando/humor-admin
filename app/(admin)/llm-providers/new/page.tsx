import { createLLMProvider } from "@/app/actions/llm-providers";
  ...
  return (
    <div className="p-8 max-w-2xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-slate-800 mt-2">Add LLM Provider</h1>
      </div>

      <div className="bg-white rounded-xl border border-slate-200 p-6">
        <form action={createLLMProvider} className="space-y-5">
          <div>
