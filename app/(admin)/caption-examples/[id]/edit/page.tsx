...
import { updateCaptionExample } from "@/app/actions/caption-examples";
  ...
  return (
    <div className="p-8 max-w-2xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-slate-800 mt-2">Edit Caption Example</h1>
        ...
        <form action={updateWithId} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              defaultValue={example.humor_flavor_id ?? ""}
